...
export class MascotaRepositoryImpl implements MascotaRepository {
  ...
  AgregarMascotas(Mascota: MascotaEntity): Promise<void> {
    return new Promise((resolve, reject) => {
      ...
      this.MascotaImplements.save(NuevoMascota)
        .then(() => {
          resolve();
        })
        .catch((error) => {
  ...
  EliminarMascotas(Mascota: MascotaEntity): Promise<void> {
    return new Promise((resolve, reject) => {
      this.MascotaImplements.deleteOne(Mascota)
        .then(() => {
          resolve();
        })
        .catch((error) => {
      ...
      this.MascotaImplements.findOne({
        ...
        .then((mascota) => {
          if (mascota) {
            ...
            reject('NO se encuentra la mascota');
          }
        })
        .catch((error) => {
          reject(error);
  ...
  EditarHistorialMascota(Mascota: MascotaEntity): Promise<void> {
    return new Promise((resolve, reject) => {
      this.MascotaImplements.update(Mascota._id, Mascota)
        .then(() => {
          resolve();
        })
        .catch((error) => {
  ...
  findByCN(id: number, nombre: string): Promise<MascotaEntity> {
    return new Promise((resolve, reject) => {
      this.MascotaImplements.findOne({
        where: { Cedula: id, NombreMascota: nombre },
      })
        .then((mascota) => {
          resolve(mascota);
        })
